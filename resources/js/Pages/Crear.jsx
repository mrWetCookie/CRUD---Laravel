...
const Crear = ({ auth }) => {
    ...
    const store = async (e) => {
        ...
        router.visit('/dashboard'); // Redirige usando Inertia.js
    };
        ...
        {/* Segunda parte */}
            ...
            <div>
              ...
              <br/>
                ...
                <br/>
                <div class="space-y-2">
                <button type="submit" class="bg-[#111827] text-white px-4 h-16 py-2 rounded w-full hover:bg-gray-700 active:bg-[#6400a9]">Crear producto</button><br/>
                </div>
                </div>
              </div>
            </div>
